...
public class CalculatorUI {
        ...
        switch (operator) {
            ...
            case '/':
                if (secondNumber != 0) {
                    ...
                    JOptionPane.showMessageDialog(window, "Division by zero is not allowed!", "Error", JOptionPane.ERROR_MESSAGE);
                    return 0;
                }
            case '%':
                return firstNumber % secondNumber;
    ...
    private void initButtons(int[] columns, int[] rows) {
        ...
        btn1.addActionListener(createNumberButtonActionListener("1"));

        btn2 = createButton("2", columns[1], rows[4]);
        btn2.addActionListener(createNumberButtonActionListener("2"));

        btn3 = createButton("3", columns[2], rows[4]);
        btn3.addActionListener(createNumberButtonActionListener("3"));

        btn4 = createButton("4", columns[0], rows[3]);
        btn4.addActionListener(createNumberButtonActionListener("4"));

        btn5 = createButton("5", columns[1], rows[3]);
        btn5.addActionListener(createNumberButtonActionListener("5"));

        btn6 = createButton("6", columns[2], rows[3]);
        btn6.addActionListener(createNumberButtonActionListener("6"));

        btn7 = createButton("7", columns[0], rows[2]);
        btn7.addActionListener(createNumberButtonActionListener("7"));

        btn8 = createButton("8", columns[1], rows[2]);
        btn8.addActionListener(createNumberButtonActionListener("8"));

        btn9 = createButton("9", columns[2], rows[2]);
        btn9.addActionListener(createNumberButtonActionListener("9"));

        btn0 = createButton("0", columns[1], rows[5]);
        btn0.addActionListener(createNumberButtonActionListener("0"));
    ...
    private ActionListener createNumberButtonActionListener(String number) {
        return event -> {
            if (addToDisplay) {
    ...
    private void applyTheme(Theme theme) {
        // Apply theme colors to the components
        // ...
    }
